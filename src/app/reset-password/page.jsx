...
//               name="newPassword"
//               placeholder="Enter new password"
//               className={`w-full p-2 border rounded-md outline-none ${error && error.toLowerCase().includes("new")
//                   ? "border-red-500"
//                   : "border-gray-300"
//                 }`}
//               value={formData.newPassword}
...
//               name="confirmPassword"
//               placeholder="Confirm new password"
//               className={`w-full p-2 border rounded-md outline-none ${error && error.toLowerCase().includes("match")
//                   ? "border-red-500"
//                   : "border-gray-300"
//                 }`}
//               value={formData.confirmPassword}
...
//           {message && <p className="text-left text-green-600 text-sm mb-2">{message}</p>}
