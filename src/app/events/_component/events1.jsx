  ...
  return (
    <section className="min-h-full bg-white px-4 md:px-16 py-10 text-gray-800 relative">
      <section>
        {/* ✅ Slider Section */}
        {events.length > 0 && (
          <div className="w-full bg-gradient-to-b from-gray-200 to-white py-10 mt-10">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 px-4">
              ...
              <div className="relative flex-1 flex justify-center py-14">
                ...
                <Image
                  src={events[current]?.image || "/placeholder.png"}
                  width={350}
                  height={450}
                  alt="Event poster"
        ...
        <div className="mt-14 max-w-7xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {events.map((event) => (
              ...
              >
                <img
                  src={event.banner || event.image || "/placeholder.png"}
                  alt={event.title}
                ...
                <div className="p-4">
                  ...
                  <button
                    onClick={() => router.push(`/ticketdetails/${event._id}`)}
                    className="bg-black text-white px-2 py-1 rounded-md text-sm font-semibold"
                  >
                    Buy tickets
                  </button>
                </div>
